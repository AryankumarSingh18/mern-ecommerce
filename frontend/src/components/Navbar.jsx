					...
					<nav className='flex flex-wrap items-center gap-2 sm:gap-4'>
						...
						{user && (
							...
							>
								...
								{cart.length > 0 && (
									<span
										className='absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-1.5 py-0.5
						...
						{user ? (
							<button
								className='bg-gray-700 hover:bg-gray-600 text-white py-1.5 px-3 sm:py-2 sm:px-4
							...
							<>
								<Link
									to={"/signup"}
									className='bg-emerald-600 hover:bg-emerald-700 text-white py-1.5 px-3 sm:py-2 sm:px-4
									rounded-md flex items-center transition duration-300 ease-in-out text-sm'
								>
								...
								<Link
									...
									rounded-md flex items-center transition duration-300 ease-in-out text-sm'
								>
									<LogIn className='mr-1 sm:mr-2' size={16} />
									<span>Login</span>
								</Link>
							</>
						)}
